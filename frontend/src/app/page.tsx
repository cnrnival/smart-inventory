...
export default function DashboardPage() {
  ...
  // ✅ LÓGICA ADICIONADA: Proteção para o gráfico carregar no Vercel
  ...
  // Lógica de cálculo da Dashboard (Sua lógica original)
  ...
  // ✅ LÓGICA ADICIONADA: Se não for cliente, não renderiza o gráfico (evita erro width -1)
