    ...
    return (
        <div className="flex-1 flex flex-col bg-[#E8E9E8] h-full">
            ...
            <div className="flex-1 flex flex-col items-center p-4 overflow-hidden md:h-[100vh] sm:min-h-screen rounded-md sm:text-sm md:text-base">
                ...
                <div className="w-full flex flex-row h-[50px] justify-between bg-[#c9c9c9] flex items-center rounded-md p-4 mb-3">
                    <input
                        type="text"
                 ...
                 <div className="w-full flex flex-row h-[50px] justify-between  flex items-center rounded-md p-4 shrink-0 text-black border border-black/50 flex flex-row items-center gap-4 space-between bg-[#c9c9c9]">
                            <span>nome</span>
                            <span>preço</span>
                            <span>data de validade</span>
                </div>
                <ul className="w-full flex-1 bg-[#c9c9c9] rounded-b-md overflow-y-auto min-h-0 hide-scrollbar">
